...
trait Channel extends Actor {
  ...
  /**
   * Channel id generated by [[org.eligosource.eventsourced.core.Context]].
   */
  def id: Int
  ...
  /**
   * Channel destination. Set when a channel is added to a
...
object ReliableChannelConf {
  ...
  /**
   * Returns a [[org.eligosource.eventsourced.core.ReliableChannelConf]] with default settings.
   */
