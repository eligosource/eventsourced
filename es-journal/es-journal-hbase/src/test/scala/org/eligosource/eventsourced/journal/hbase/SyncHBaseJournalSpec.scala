...
class SyncHBaseJournalSpec extends JournalSpec with HBaseCleanup with BeforeAndAfterEach with BeforeAndAfterAll {
  val journalProps = SyncHBaseJournalProps(HBaseConfiguration.create())
  ...
  override def beforeAll() {
    ...
    CreateSchema(journalProps.configuration)
